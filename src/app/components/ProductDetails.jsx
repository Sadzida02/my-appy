...
async function ProductDetails({params}) {
    ...
    return (
      ...
      <div className=' w-[1240px] mx-[90px] h-[550px] mt-[170px]'> 
      <nav>
  ...
  <div className='pb-3'><span className='text-sm'>Rating: 
              </span><FontAwesomeIcon icon={ faStar } /><FontAwesomeIcon icon={ faStar } /><FontAwesomeIcon icon={ faStar } /><FontAwesomeIcon icon={ faStar } /><FontAwesomeIcon icon={ faStar } /></div>
